...
bool GraphicsClass::Initialize(int screenWidth, int screenHeight, HWND hwnd)
{
	...
	result = fire_model->FireInitialize(m_D3D->GetDevice(), (char*)"../directx project/data/square.txt", (WCHAR*)L"../directx project/data/fire01.dds",
		(WCHAR*)L"../directx project/data/noise01.dds", (WCHAR*)L"../directx project/data/alpha01.dds");
	if (!result)
	{
	...
	for (int i = 0; i < 12; i++)
	{
		...
		result = wall1_model[i]->Initialize(m_D3D->GetDevice(), (char*)"../directx project/data/1.obj", (WCHAR*)L"../directx project/data/Wall/Wall.dds", &all_polygons);
		if (!result)
		{
	...
	for (int i = 0; i < 6; i++)
	{
		...
		// Initialize the model object.
		//desk_model->SetPosition(0.0f, 0.0f, 0.0f);
		result = wall2_model[i]->Initialize(m_D3D->GetDevice(), (char*)"../directx project/data/2.obj", (WCHAR*)L"../directx project/data/Wall/Wall.dds", &all_polygons);
		if (!result)
		{
			MessageBox(hwnd, L"Could not initialize the model1 object.", L"Error", MB_OK);
			return false;
	...
	for (int i = 0; i < 12; i++)
	{
		...
		// Initialize the model object.
		//desk_model->SetPosition(0.0f, 0.0f, 0.0f);
		result = wall3_model[i]->Initialize(m_D3D->GetDevice(), (char*)"../directx project/data/3.obj", (WCHAR*)L"../directx project/data/Wall/Wall.dds", &all_polygons);
		if (!result)
		{
			MessageBox(hwnd, L"Could not initialize the model1 object.", L"Error", MB_OK);
			return false;
	...
	for (int i = 0; i < 2; i++)
	{
		...
		// Initialize the model object.
		//desk_model->SetPosition(0.0f, 0.0f, 0.0f);
		result = wall4_model[i]->Initialize(m_D3D->GetDevice(), (char*)"../directx project/data/4.obj", (WCHAR*)L"../directx project/data/Wall/Wall.dds", &all_polygons);
		if (!result)
		{
			MessageBox(hwnd, L"Could not initialize the model1 object.", L"Error", MB_OK);
			return false;
	...
	for (int i = 0; i < 2; i++)
	{
		...
		// Initialize the model object.
		//desk_model->SetPosition(0.0f, 0.0f, 0.0f);
		result = wall5_model[i]->Initialize(m_D3D->GetDevice(), (char*)"../directx project/data/5.obj", (WCHAR*)L"../directx project/data/Wall/Wall.dds", &all_polygons);
		if (!result)
		{
			MessageBox(hwnd, L"Could not initialize the model1 object.", L"Error", MB_OK);
			return false;
	...
	for (int i = 0; i < 2; i++)
	{
		...
		// Initialize the model object.
		//desk_model->SetPosition(0.0f, 0.0f, 0.0f);
		result = wall6_model[i]->Initialize(m_D3D->GetDevice(), (char*)"../directx project/data/6.obj", (WCHAR*)L"../directx project/data/Wall/Wall.dds", &all_polygons);
		if (!result)
		{
			MessageBox(hwnd, L"Could not initialize the model1 object.", L"Error", MB_OK);
			return false;
	...
	// Initialize the model object.
	//desk_model->SetPosition(0.0f, 0.0f, 0.0f);
	result = wall9_model->Initialize(m_D3D->GetDevice(), (char*)"../directx project/data/9.obj", (WCHAR*)L"../directx project/data/Wall/Wall.dds", &all_polygons);
	if (!result)
	{
		MessageBox(hwnd, L"Could not initialize the model1 object.", L"Error", MB_OK);
		return false;
	...
	result = torch_model->Initialize(m_D3D->GetDevice(), (char*)"../directx project/data/torch.obj", (WCHAR*)L"../directx project/data/torch.dds", &all_polygons);
	if (!result)
	{
	...
	// Initialize the model object.
	//chair_model->SetPosition(0.0f, 0.0f, -50.0f);
	result = enterance_model->Initialize(m_D3D->GetDevice(), (char*)"../directx project/data/enterance.obj", (WCHAR*)L"../directx project/data/Door/Door.dds", &all_polygons);
	if (!result)
	{
	...
	// Initialize the model object.
	//chair_model->SetPosition(0.0f, 0.0f, -50.0f);
	result = door_model->Initialize(m_D3D->GetDevice(), (char*)"../directx project/data/Door/Door.obj", (WCHAR*)L"../directx project/data/Door/Door.dds", &all_polygons);
	if (!result)
	{
	...
	result = key_model->Initialize(m_D3D->GetDevice(), (char*)"../directx project/data/Key/Key.obj", (WCHAR*)L"../directx project/data/Key/Key.dds", &all_polygons);
	if (!result)
	{
	...
	// Initialize the model object.
	//bookshelf_model->SetPosition(1.0f, -2.0f, 50.0f);
	result = farWall_model->Initialize(m_D3D->GetDevice(), (char*)"../directx project/data/FarWall/FarWall.obj", (WCHAR*)L"../directx project/data/FarWall/FarWall.dds", &all_polygons);
	if (!result)
	{
	...
	// Initialize the model object.
	//bookshelf_model->SetPosition(1.0f, -2.0f, 50.0f);
	result = ceiling_model->Initialize(m_D3D->GetDevice(), (char*)"../directx project/data/Ceiling/Ceiling.obj", (WCHAR*)L"../directx project/data/Ceiling/Ceiling.dds", &all_polygons);
	if (!result)
	{
	...
	result = plane_model->Initialize(m_D3D->GetDevice(), (char*)"../directx project/data/Floor.obj", (WCHAR*)L"../directx project/data/Floor.dds", &all_polygons);
	if (!result)
	{
		MessageBox(hwnd, L"Could not initialize the model object.", L"Error", MB_OK);
		return false;
	...
	// Initialize the model object.
	//chair_model->SetPosition(0.0f, 0.0f, -50.0f);
	result = monster_model->Initialize(m_D3D->GetDevice(), (char*)"../directx project/data/monster/Monster.obj", (WCHAR*)L"../directx project/data/monster/diffuso.dds", &all_polygons);
	if (!result)
	{
		MessageBox(hwnd, L"Could not initialize the torch object.", L"Error", MB_OK);
		return false;
	...
	// Initialize the model object.
	//chair_model->SetPosition(0.0f, 0.0f, -50.0f);
	result = knife_model->Initialize(m_D3D->GetDevice(), (char*)"../directx project/data/monster/Knife.obj", (WCHAR*)L"../directx project/data/monster/knife_hand.dds", &all_polygons);
	if (!result)
	{
		MessageBox(hwnd, L"Could not initialize the torch object.", L"Error", MB_OK);
		return false;
	...
	result = m_Bitmap->Initialize(m_D3D->GetDevice(), screenWidth, screenHeight,
		(WCHAR*)L"../directx project/data/plane.dds", 256, 256);
	if (!result)
	{
