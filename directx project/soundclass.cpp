...
bool SoundClass::Initialize(HWND hwnd)
{
	...
	result = LoadWaveFile((char*)"../directx project/data/sound/cave.wav", &m_secondaryBuffer1);
	if (!result)
	{
		return false;
	}
	...
	// Load a wave audio file onto a secondary buffer.
	result = LoadWaveFile((char*)"../directx project/data/sound/key.wav", &m_secondaryBuffer2);
	if (!result)
	{
		return false;
	}
	...
	// Load a wave audio file onto a secondary buffer.
	result = LoadWaveFile((char*)"../directx project/data/sound/diesound.wav", &m_secondaryBuffer3);
	if (!result)
	{
		return false;
	}
	...
	// Load a wave audio file onto a secondary buffer.
	result = LoadWaveFile((char*)"../directx project/data/sound/killsound.wav", &m_secondaryBuffer4);
	if (!result)
	{
		return false;
	}
	...
	// Load a wave audio file onto a secondary buffer.
	result = LoadWaveFile((char*)"../directx project/data/sound/monsterdie.wav", &m_secondaryBuffer5);
	if (!result)
	{
		return false;
	}
	...
	// Load a wave audio file onto a secondary buffer.
	result = LoadWaveFile((char*)"../directx project/data/sound/playerdie.wav", &m_secondaryBuffer6);
	if (!result)
	{
		return false;
	}
	...
	// Load a wave audio file onto a secondary buffer.
	result = LoadWaveFile((char*)"../directx project/data/sound/swing.wav", &m_secondaryBuffer7);
	if (!result)
	{
		return false;
	}
